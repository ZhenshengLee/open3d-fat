...
# 全部用源编译
cmake .. -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=/opt/open3d/open3d -DBUILD_CUDA_MODULE=OFF -DBUILD_PYTHON_MODULE=OFF -DBUILD_GUI=OFF -DBUILD_JUPYTER_EXTENSION=OFF -DUSE_BLAS=ON -DWITH_FAISS=ON
```
